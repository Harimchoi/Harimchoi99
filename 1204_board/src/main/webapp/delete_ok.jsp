...
if(pwd.equals(rs.getString("pwd"))){
	//4-1.수정
	//4-1.1 쿼리생성
	String sql_update = "delete from board where id=?";
	//4-1.2 심부름꾼
	...
	String sql_delete = "delete from dat where board_id=?";
	PreparedStatement pstmt3 = conn.prepareStatement(sql_delete);
	...
	//4-2.되돌아가기	
	response.sendRedirect("delete.jsp?chk=1&id="+id+"&pager="+request.getParameter("pager"));
}
//5
rs.close();
pstmt.close();
