...
<form action="delete_ok.jsp" method="get">
	...
	<tr>
		...
		<input type="hidden" value="<%=request.getParameter("pager")%>" name="pager">
		<input type="submit" value="삭제"  class="red">
		<input type="button" value="취소" onclick="location='content.jsp?id=<%=request.getParameter("id")%>&pgaer=<%=request.getParameter("pager")%>'">
		</td>
	</tr>
</table>
</form>
