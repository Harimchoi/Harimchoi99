...
public class 게시물 {
	...
	//메소드[미리 작성된 코드 => 코드의 재활용]
		...
		public static void 게시물등록() {
			...
			System.out.println("제목 : "); String 제목 = Day06_4_게시판.입력객체.next();
			System.out.println("내용 : "); String 내용 = Day06_4_게시판.입력객체.next();
			System.out.println("작성자 : "); String 작성자 = Day06_4_게시판.입력객체.next();
		...
		public static void 게시물출력() {
			...
			System.out.println(i+"\t"+ Day06_4_게시판.게시물목록.get(i).제목+"\t"+ Day06_4_게시판.게시물목록.get(i).작성자+"\t"+ Day06_4_게시판.게시물목록.get(i).조회수+"\t");
			}
		}
